"""
Django settings for IndividualProject_2 project.
...
ROOT_URLCONF = 'IndividualProject_2.urls'
...
WSGI_APPLICATION = 'IndividualProject_2.wsgi.application'
